...
(function (exports) {
    class Revealer {
        ...
        revealSafe(cellIndex, indexQueue) {
        ...
        iterativeReveal(cellIndex, indexesQueue) {
            const field = this.field;
